...
class ActivateJobsRequest(_message.Message):
    __slots__ = ["type", "worker", "timeout", "maxJobsToActivate", "fetchVariable", "requestTimeout"]
    ...
    requestTimeout: int
    def __init__(self, type: _Optional[str] = ..., worker: _Optional[str] = ..., timeout: _Optional[int] = ..., maxJobsToActivate: _Optional[int] = ..., fetchVariable: _Optional[_Iterable[str]] = ..., requestTimeout: _Optional[int] = ...) -> None: ...
...
class ActivatedJob(_message.Message):
    __slots__ = ["key", "type", "processInstanceKey", "bpmnProcessId", "processDefinitionVersion", "processDefinitionKey", "elementId", "elementInstanceKey", "customHeaders", "worker", "retries", "deadline", "variables"]
...
class CreateProcessInstanceRequest(_message.Message):
    __slots__ = ["processDefinitionKey", "bpmnProcessId", "version", "variables", "startInstructions"]
    PROCESSDEFINITIONKEY_FIELD_NUMBER: _ClassVar[int]
    BPMNPROCESSID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, processDefinitionKey: _Optional[int] = ..., bpmnProcessId: _Optional[str] = ..., version: _Optional[int] = ..., variables: _Optional[str] = ..., startInstructions: _Optional[_Iterable[_Union[ProcessInstanceCreationStartInstruction, _Mapping]]] = ...) -> None: ...
...
class CreateProcessInstanceResponse(_message.Message):
    __slots__ = ["processDefinitionKey", "bpmnProcessId", "version", "processInstanceKey"]
    PROCESSDEFINITIONKEY_FIELD_NUMBER: _ClassVar[int]
    BPMNPROCESSID_FIELD_NUMBER: _ClassVar[int]
    VERSION_FIELD_NUMBER: _ClassVar[int]
    PROCESSINSTANCEKEY_FIELD_NUMBER: _ClassVar[int]
    ...
    version: int
    processInstanceKey: int
    def __init__(self, processDefinitionKey: _Optional[int] = ..., bpmnProcessId: _Optional[str] = ..., version: _Optional[int] = ..., processInstanceKey: _Optional[int] = ...) -> None: ...
...
class CreateProcessInstanceWithResultResponse(_message.Message):
    __slots__ = ["processDefinitionKey", "bpmnProcessId", "version", "processInstanceKey", "variables"]
    PROCESSDEFINITIONKEY_FIELD_NUMBER: _ClassVar[int]
    BPMNPROCESSID_FIELD_NUMBER: _ClassVar[int]
    VERSION_FIELD_NUMBER: _ClassVar[int]
    PROCESSINSTANCEKEY_FIELD_NUMBER: _ClassVar[int]
    ...
    processInstanceKey: int
    variables: str
    def __init__(self, processDefinitionKey: _Optional[int] = ..., bpmnProcessId: _Optional[str] = ..., version: _Optional[int] = ..., processInstanceKey: _Optional[int] = ..., variables: _Optional[str] = ...) -> None: ...

class EvaluateDecisionRequest(_message.Message):
    __slots__ = ["decisionKey", "decisionId", "variables"]
    ...
    decisionId: str
    variables: str
    def __init__(self, decisionKey: _Optional[int] = ..., decisionId: _Optional[str] = ..., variables: _Optional[str] = ...) -> None: ...

class EvaluateDecisionResponse(_message.Message):
    __slots__ = ["decisionKey", "decisionId", "decisionName", "decisionVersion", "decisionRequirementsId", "decisionRequirementsKey", "decisionOutput", "evaluatedDecisions", "failedDecisionId", "failureMessage"]
    DECISIONKEY_FIELD_NUMBER: _ClassVar[int]
    DECISIONID_FIELD_NUMBER: _ClassVar[int]
    ...
    failureMessage: str
    def __init__(self, decisionKey: _Optional[int] = ..., decisionId: _Optional[str] = ..., decisionName: _Optional[str] = ..., decisionVersion: _Optional[int] = ..., decisionRequirementsId: _Optional[str] = ..., decisionRequirementsKey: _Optional[int] = ..., decisionOutput: _Optional[str] = ..., evaluatedDecisions: _Optional[_Iterable[_Union[EvaluatedDecision, _Mapping]]] = ..., failedDecisionId: _Optional[str] = ..., failureMessage: _Optional[str] = ...) -> None: ...

class EvaluatedDecision(_message.Message):
    __slots__ = ["decisionKey", "decisionId", "decisionName", "decisionVersion", "decisionType", "decisionOutput", "matchedRules", "evaluatedInputs"]
    DECISIONKEY_FIELD_NUMBER: _ClassVar[int]
    DECISIONID_FIELD_NUMBER: _ClassVar[int]
    DECISIONNAME_FIELD_NUMBER: _ClassVar[int]
    DECISIONVERSION_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, decisionKey: _Optional[int] = ..., decisionId: _Optional[str] = ..., decisionName: _Optional[str] = ..., decisionVersion: _Optional[int] = ..., decisionType: _Optional[str] = ..., decisionOutput: _Optional[str] = ..., matchedRules: _Optional[_Iterable[_Union[MatchedDecisionRule, _Mapping]]] = ..., evaluatedInputs: _Optional[_Iterable[_Union[EvaluatedDecisionInput, _Mapping]]] = ...) -> None: ...
...
class DeployResourceResponse(_message.Message):
    __slots__ = ["key", "deployments"]
    KEY_FIELD_NUMBER: _ClassVar[int]
    DEPLOYMENTS_FIELD_NUMBER: _ClassVar[int]
    key: int
    deployments: _containers.RepeatedCompositeFieldContainer[Deployment]
    def __init__(self, key: _Optional[int] = ..., deployments: _Optional[_Iterable[_Union[Deployment, _Mapping]]] = ...) -> None: ...

class Deployment(_message.Message):
    __slots__ = ["process", "decision", "decisionRequirements"]
    ...
    def __init__(self, process: _Optional[_Union[ProcessMetadata, _Mapping]] = ..., decision: _Optional[_Union[DecisionMetadata, _Mapping]] = ..., decisionRequirements: _Optional[_Union[DecisionRequirementsMetadata, _Mapping]] = ...) -> None: ...

class ProcessMetadata(_message.Message):
    __slots__ = ["bpmnProcessId", "version", "processDefinitionKey", "resourceName"]
    BPMNPROCESSID_FIELD_NUMBER: _ClassVar[int]
    VERSION_FIELD_NUMBER: _ClassVar[int]
    PROCESSDEFINITIONKEY_FIELD_NUMBER: _ClassVar[int]
    ...
    processDefinitionKey: int
    resourceName: str
    def __init__(self, bpmnProcessId: _Optional[str] = ..., version: _Optional[int] = ..., processDefinitionKey: _Optional[int] = ..., resourceName: _Optional[str] = ...) -> None: ...

class DecisionMetadata(_message.Message):
    __slots__ = ["dmnDecisionId", "dmnDecisionName", "version", "decisionKey", "dmnDecisionRequirementsId", "decisionRequirementsKey"]
    ...
    decisionRequirementsKey: int
    def __init__(self, dmnDecisionId: _Optional[str] = ..., dmnDecisionName: _Optional[str] = ..., version: _Optional[int] = ..., decisionKey: _Optional[int] = ..., dmnDecisionRequirementsId: _Optional[str] = ..., decisionRequirementsKey: _Optional[int] = ...) -> None: ...

class DecisionRequirementsMetadata(_message.Message):
    __slots__ = ["dmnDecisionRequirementsId", "dmnDecisionRequirementsName", "version", "decisionRequirementsKey", "resourceName"]
    DMNDECISIONREQUIREMENTSID_FIELD_NUMBER: _ClassVar[int]
    ...
    decisionRequirementsKey: int
    resourceName: str
    def __init__(self, dmnDecisionRequirementsId: _Optional[str] = ..., dmnDecisionRequirementsName: _Optional[str] = ..., version: _Optional[int] = ..., decisionRequirementsKey: _Optional[int] = ..., resourceName: _Optional[str] = ...) -> None: ...
...
class PublishMessageRequest(_message.Message):
    __slots__ = ["name", "correlationKey", "timeToLive", "messageId", "variables"]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    messageId: str
    variables: str
    def __init__(self, name: _Optional[str] = ..., correlationKey: _Optional[str] = ..., timeToLive: _Optional[int] = ..., messageId: _Optional[str] = ..., variables: _Optional[str] = ...) -> None: ...
...
class ResolveIncidentRequest(_message.Message):
    __slots__ = ["incidentKey"]
    INCIDENTKEY_FIELD_NUMBER: _ClassVar[int]
    incidentKey: int
    def __init__(self, incidentKey: _Optional[int] = ...) -> None: ...
...
class UpdateJobRetriesRequest(_message.Message):
    __slots__ = ["jobKey", "retries"]
    JOBKEY_FIELD_NUMBER: _ClassVar[int]
    RETRIES_FIELD_NUMBER: _ClassVar[int]
    jobKey: int
    retries: int
    def __init__(self, jobKey: _Optional[int] = ..., retries: _Optional[int] = ...) -> None: ...
...
class SetVariablesRequest(_message.Message):
    __slots__ = ["elementInstanceKey", "variables", "local"]
    ELEMENTINSTANCEKEY_FIELD_NUMBER: _ClassVar[int]
    VARIABLES_FIELD_NUMBER: _ClassVar[int]
    ...
    variables: str
    local: bool
    def __init__(self, elementInstanceKey: _Optional[int] = ..., variables: _Optional[str] = ..., local: bool = ...) -> None: ...
...
class ModifyProcessInstanceRequest(_message.Message):
    __slots__ = ["processInstanceKey", "activateInstructions", "terminateInstructions"]
    ...
    def __init__(self, processInstanceKey: _Optional[int] = ..., activateInstructions: _Optional[_Iterable[_Union[ModifyProcessInstanceRequest.ActivateInstruction, _Mapping]]] = ..., terminateInstructions: _Optional[_Iterable[_Union[ModifyProcessInstanceRequest.TerminateInstruction, _Mapping]]] = ...) -> None: ...
...
class DeleteResourceRequest(_message.Message):
    __slots__ = ["resourceKey"]
    RESOURCEKEY_FIELD_NUMBER: _ClassVar[int]
    resourceKey: int
    def __init__(self, resourceKey: _Optional[int] = ...) -> None: ...
...
class BroadcastSignalRequest(_message.Message):
    __slots__ = ["signalName", "variables"]
    SIGNALNAME_FIELD_NUMBER: _ClassVar[int]
    VARIABLES_FIELD_NUMBER: _ClassVar[int]
    signalName: str
    variables: str
    def __init__(self, signalName: _Optional[str] = ..., variables: _Optional[str] = ...) -> None: ...
